...
Best measured GPU static-HMC is 4.29x faster than the best measured M4 NumPyro sampler on seconds per minimum ESS. Raw posterior draws/sec ratio is 9.55x.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Linux / JAX gpu | JAX static HMC | 1 | 16 | 32 | 40 | 15 | 1.000 | cold compile+run | 156.6 | 0.204 | 15.81 | 9.904 | 1.142 | 0.925 |
| macOS / JAX cpu | JAX static HMC | 2 | 1 | 2 | 10 | 15 | 0.020 | cold compile+run | 45.94 | 0.087 | 1.335 | 34.41 |  | 1.000 |
| Linux / JAX gpu | JAX static HMC | 2 | 16 | 32 | 40 | 15 | 1.000 | cold compile+run | 170.2 | 0.376 | 5.024 | 33.89 | 1.142 | 0.889 |
...
| Linux / JAX gpu | JAX static HMC | 32 | 16 | 32 | 40 | 15 | 1.000 | cold compile+run | 295.2 | 3.469 | 556.8 | 0.530 | 1.039 | 0.867 |
| Linux / JAX gpu | JAX static HMC | 64 | 16 | 32 | 40 | 15 | 1.000 | cold compile+run | 380.3 | 5.386 | 1248 | 0.305 | 1.032 | 0.870 |
| Linux / JAX gpu | JAX static HMC | 100 | 16 | 32 | 40 | 15 | 1.000 | cold compile+run | 420.4 | 7.612 | 2045 | 0.206 | 1.031 | 0.869 |
